...
BASIC_LDFLAGS="-lstdc++ -L/usr/local/lib/ -L/opt/local/lib $LDFLAGS"

USE_CFLAGS="-fstack-protector-all -fPIE -D_FORTIFY_SOURCE=2 -g -ggdb \
            $BASIC_CFLAGS"

USE_LDFLAGS="-lstdc++ -Wl,-z,relro -pie $BASIC_LDFLAGS"
...
OBJFILES="p0f-utils.cpp p0f-api.cpp p0f-process.cpp fp_tcp.cpp fp_mtu.cpp fp_http.cpp readfp.cpp"
...
$CC $USE_CFLAGS $USE_LDFLAGS "$PROGNAME.cpp" $OBJFILES -o "$PROGNAME" $USE_LIBS &>"$TMP.log"
